...
import kotlinx.android.synthetic.main.fragment_baak__news.*
 ...
 *
 */
class BAAKNewsFragment : Fragment(), BAAKNewsContract.View {

    private lateinit var presenter: BAAKNewsPresenter
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        presenter = BAAKNewsPresenter(this, request)
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_baak__news, container, false)
    }
